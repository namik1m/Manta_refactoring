//30th March 2023 안경수선생님
class MediaPlayer {
    constructor(number, imagename, videoId) {
      let contents = `
    ...
    `;
      ...
      let frame = document.getElementById("pf_" + number);
  ...
  for (let i in playList) {
    let item = playList[i];
    console.log(i, item);
    var mp = new MediaPlayer(parseInt(i) + 1, item.image, item.videoId);
    playerList.push(mp);
  }